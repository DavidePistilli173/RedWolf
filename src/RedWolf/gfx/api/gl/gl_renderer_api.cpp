...
void rw::gfx::api::gl::RendererApi::draw_indexed(const VertexArray* vertex_array, const uint32_t index_count) {
    if (0 == index_count) {
...
void rw::gfx::api::gl::RendererApi::init() {
    ...
    glDebugMessageCallback(&RendererApi::error_callback_, 0);
...
void rw::gfx::api::gl::RendererApi::error_callback_(
    GLenum                       source,
    GLenum                       type,
