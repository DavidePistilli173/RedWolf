...
rw::gfx::api::gl::Framebuffer::Framebuffer(const rw::gfx::FramebufferDescriptor& descriptor) : descriptor_{ descriptor } {
    if (recreate()) {
        RW_CORE_TRACE("Framebuffer buffer {} created.", id_);
    }
}
rw::gfx::api::gl::Framebuffer::~Framebuffer() {
...
rw::gfx::api::gl::Framebuffer::Framebuffer(Framebuffer&& other) :
...
rw::gfx::api::gl::Framebuffer& rw::gfx::api::gl::Framebuffer::operator=(Framebuffer&& other) {
    if (this != &other) {
        id_       = other.id_;
        other.id_ = 0U;
...
void rw::gfx::api::gl::Framebuffer::bind() const {
...
const rw::gfx::FramebufferDescriptor& rw::gfx::api::gl::Framebuffer::descriptor() const {
    return descriptor_;
}

bool rw::gfx::api::gl::Framebuffer::recreate() {
...
void rw::gfx::api::gl::Framebuffer::unbind() {
    glBindFramebuffer(GL_FRAMEBUFFER, 0);
}
