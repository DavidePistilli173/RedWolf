...
rw::gfx::Shader::Shader(const std::string& vertex_src, const std::string& fragment_src) {
...
rw::gfx::Shader::Shader(const std::string& file_path) {
    const auto shader_sources{ pre_process_(read_file_(file_path)) };
    compile_(shader_sources);
    RW_CORE_TRACE("Shader {} created from {}.", id_, file_path);
}

rw::gfx::Shader::~Shader() {
    glDeleteProgram(id_);
    RW_CORE_TRACE("Deleted shader {}", id_);
}

void rw::gfx::Shader::bind() const {
    glUseProgram(id_);
}

void rw::gfx::Shader::unbind() const {
    glUseProgram(0);
}

void rw::gfx::Shader::set_f32(const std::string_view name, const float value) const {
    upload_uniform_f32_(name, value);
}

void rw::gfx::Shader::set_f32_2(const std::string_view name, const rw::math::Vec2& vec) const {
    upload_uniform_f32_2_(name, vec);
}

void rw::gfx::Shader::set_f32_3(const std::string_view name, const rw::math::Vec3& vec) const {
    upload_uniform_f32_3_(name, vec);
}

void rw::gfx::Shader::set_f32_4(const std::string_view name, const rw::math::Vec4& vec) const {
    upload_uniform_f32_4_(name, vec);
}

void rw::gfx::Shader::set_i32(const std::string_view name, const int32_t value) const {
    upload_uniform_i32_(name, value);
}

void rw::gfx::Shader::set_i32_array(const std::string_view name, const std::span<const int32_t> values) const {
    upload_uniform_i32_array_(name, values);
}

void rw::gfx::Shader::set_mat_f32_3(const std::string_view name, const rw::math::Mat3& matrix) const {
    upload_uniform_mat_f32_3_(name, matrix);
}

void rw::gfx::Shader::set_mat_f32_4(const std::string_view name, const rw::math::Mat4& matrix) const {
    upload_uniform_mat_f32_4_(name, matrix);
}

void rw::gfx::Shader::compile_(const std::unordered_map<GLenum, std::string>& shader_sources) {
...
std::unordered_map<GLenum, std::string> rw::gfx::Shader::pre_process_(const std::string& source) {
...
std::string rw::gfx::Shader::read_file_(const std::string& path) {
...
void rw::gfx::Shader::upload_uniform_f32_(const std::string_view name, const float value) const {
...
void rw::gfx::Shader::upload_uniform_f32_2_(const std::string_view name, const rw::math::Vec2& vec) const {
    const GLint location{ glGetUniformLocation(id_, name.data()) };
    if (-1 == location) {
        RW_CORE_ERR("Failed to get uniform location: {}", name);
        return;
...
void rw::gfx::Shader::upload_uniform_f32_3_(const std::string_view name, const rw::math::Vec3& vec) const {
    const GLint location{ glGetUniformLocation(id_, name.data()) };
    if (-1 == location) {
        RW_CORE_ERR("Failed to get uniform location: {}", name);
        return;
...
void rw::gfx::Shader::upload_uniform_f32_4_(const std::string_view name, const rw::math::Vec4& vec) const {
    const GLint location{ glGetUniformLocation(id_, name.data()) };
    if (-1 == location) {
        RW_CORE_ERR("Failed to get uniform location: {}", name);
        return;
...
void rw::gfx::Shader::upload_uniform_i32_(const std::string_view name, const int32_t value) const {
    const GLint location{ glGetUniformLocation(id_, name.data()) };
    if (-1 == location) {
        RW_CORE_ERR("Failed to get uniform location: {}", name);
        return;
...
void rw::gfx::Shader::upload_uniform_i32_array_(const std::string_view name, const std::span<const int32_t> values) const {
    const GLint location{ glGetUniformLocation(id_, name.data()) };
    if (-1 == location) {
        RW_CORE_ERR("Failed to get uniform location: {}", name);
        return;
...
void rw::gfx::Shader::upload_uniform_mat_f32_3_(const std::string_view name, const rw::math::Mat3& matrix) const {
    const GLint location{ glGetUniformLocation(id_, name.data()) };
    if (-1 == location) {
        RW_CORE_ERR("Failed to get uniform location: {}", name);
        return;
...
void rw::gfx::Shader::upload_uniform_mat_f32_4_(const std::string_view name, const rw::math::Mat4& matrix) const {
    const GLint location{ glGetUniformLocation(id_, name.data()) };
    if (-1 == location) {
        RW_CORE_ERR("Failed to get uniform location: {}", name);
        return;
