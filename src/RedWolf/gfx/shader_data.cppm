...
export module redwolf.gfx.shader_data;
...
export namespace rw::gfx {
     ...
     */
    [[nodiscard]] constexpr uint32_t shader_data_type_size(const ShaderDataType type) {
        switch (type) {
     ...
     */
    [[nodiscard]] constexpr uint32_t shader_data_element_count(const ShaderDataType type) {
        switch (type) {
        case ShaderDataType::none:
            return 0U;
        case ShaderDataType::f32:
