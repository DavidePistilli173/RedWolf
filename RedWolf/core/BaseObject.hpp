...
namespace rw::core
{
   ...
   public:
       ...
       * @param policy Policy for generating the event.
       */
      template<rw::events::HasEventID Event>
      void generateEvent(
         const Event& evnt, rw::events::EventHandler::GenerationPolicy policy = rw::events::EventHandler::GenerationPolicy::asynchronous)
      {
         eventHandler_.generateEvent<Event>(this, evnt, policy);
      }
       ...
       */
      void handle(const rw::events::BaseEvent& evnt, const BaseObject* sender);
   ...
   protected:
      ...
      rw::RedWolfManager&     manager_;    /**< RedWolf library manager for convenient use in derived classes. */
