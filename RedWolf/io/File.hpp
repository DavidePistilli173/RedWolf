...
namespace rw::io
{
   ...
   public:
       ...
       */
      File(rw::util::Logger& logger, std::string_view filePath, OpenMode mode = OpenMode::read, Format format = Format::unknown);
...
// IMPLEMENTATION
template<typename T>
[[nodiscard]] T rw::io::File::readAllBinary() const
{
