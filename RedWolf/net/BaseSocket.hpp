...
namespace rw::net
{
    ...
    */
   class RW_API BaseSocket : public rw::core::Object
   {
   public:
      /**
       ...
       * @param logger Logger.
       */
      BaseSocket(rw::util::Logger& logger);
       ...
       */
      BaseSocket(rw::util::Logger& logger, std::string_view localAddress, std::string_view localPort, Protocol protocol, Family family);
