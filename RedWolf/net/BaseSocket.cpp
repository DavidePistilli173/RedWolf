...
BaseSocket::BaseSocket(rw::util::Logger& logger) : Object(), logger_{ logger }
{
#ifdef _WIN32
   initWinsock_();
#endif
...
BaseSocket::BaseSocket(
   rw::util::Logger& logger, std::string_view localAddress, std::string_view localPort, Protocol protocol, Family family) :
   Object(),
   logger_{ logger }
{
#ifdef _WIN32
...
void BaseSocket::userHandle_(const BaseObject* generator, const rw::evt::Event& evt) {}
