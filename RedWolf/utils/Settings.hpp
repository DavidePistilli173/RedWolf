...
namespace rw::utils
{
   ...
   private:
       ...
       */
      static std::array<rw::dat::KVPair<std::string, rw::dat::MVPair<std::unique_ptr<Settings>>>, max_settings_files>::iterator
       ...
       */
      static std::array<rw::dat::KVPair<std::string, rw::dat::MVPair<std::unique_ptr<Settings>>>, max_settings_files> instances_;
